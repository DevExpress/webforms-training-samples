<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeBehind="BookEvents.aspx.cs" Inherits="final.WebForm2" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
 <script>
    function ReplaceImage(imagehtml) {
        document.getElementById('venueImageContainer').innerHTML = imagehtml;
    }
</script>
