...
<head runat="server">
    ...
    <script>
        function splitValue() {
            const clientTotalBox = ASPxClientTextBox.Cast(totalBox);
            const value = Number(clientTotalBox.GetValue());
            if (value) {
                const clientGrid = ASPxClientGridView.Cast(grid);
                const batchApi = clientGrid.batchEditApi;
