...
<body>
    <form id="form1" runat="server">
        ...
        <dxwgv:ASPxGridView ID="ASPxGridView1" runat="server"
            ...
            <SettingsFilterControl AllowHierarchicalColumns="True" AllowNonVisualFilterExpression="True" ShowOperandTypeButton="True" />
            ...
            <Settings ShowFilterRow="True" ShowFilterRowMenu="True" ShowGroupPanel="True"
                ...
                ShowFilterBar="Auto" />
            <Columns>
                <dxwgv:GridViewDataBinaryImageColumn FieldName="FlagImage" PropertiesBinaryImage-ImageHeight="25px" VisibleIndex="1" />
                <dxwgv:GridViewDataTextColumn FieldName="SubRegion.Region.Name" Caption="Region" VisibleIndex="2" />
